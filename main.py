...
def main():
    ...
    lowest_state = 1            # Determines the lowest number state that is included in the coherent states. Defualt is zero.
    theta = np.pi / 4                   # The angle characterizing the beam splitter. Default is zero.
    mid_reset = True           # Determines whether or not we reset the atom between the early bin and late bin. Defualt is False.
